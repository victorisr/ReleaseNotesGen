...
namespace ReleaseNotesUpdater.ReleasesReadMeUpdaters
{
    public class ReadMeUpdater
    {
        ...
        private readonly JsonFileHandler _jsonFileHandler;        public ReadMeUpdater(string templateDirectory, string logFileLocation, string outputDirectory, string coreDirectory, JsonFileHandler jsonFileHandler, string configDirectory)
        {
        ...
        public void UpdateFiles()
        {
            try
            {
                ...
                string templatePath = Path.Combine(_templateDirectory, "readme-template.md");
                ...
                // Generate the markdown table and dynamic links
                string markdownTable = GenerateMarkdownTable(out string dynamicLinks);

                // Add the "[policies]" link at the end
                dynamicLinks += "\n[policies]: release-policies.md";

                // Replace the placeholder with the generated table and links
        ...
        private string GenerateMarkdownTable(out string dynamicLinks)
        {
