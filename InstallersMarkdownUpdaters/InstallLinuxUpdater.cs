...
namespace ReleaseNotesUpdater.InstallersMarkdownUpdaters
{
    public class InstallLinuxUpdater : FileUpdater
    {
        ...
        private readonly string newFileName = "install-linux";
                            ...
                            if (release != null && release.Runtime != null && release.Runtime.Version != null)
                            {
                                ...
                                if (release.Runtime.Version == runtimeId)
                                {
                                    ...
                                    if (!File.Exists(newInstallLinuxFile))
                                    {
                                        ...
                                        ModifyTemplateFile(installLinuxTemplate, newInstallLinuxFile, runtimeId, channelVersion, release, configData.LatestSdk);
                                    }
                                    else
                                    {
                                        Console.WriteLine($"File already exists: {newInstallLinuxFile}. Skipping creation.");
                                    }
                                }
                            }
                            else
